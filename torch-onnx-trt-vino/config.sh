...
IMAGE_NAME="${USER_NAME}/torch-onnx${ONNX_VERSION//./}-${ONNXRUNTIME_VERSION//./}-trt-vino-server:latest"

CONTAINER_NAME="${USER_NAME}-torch-onnx${ONNX_VERSION//./}-${ONNXRUNTIME_VERSION//./}-trt-vino-server${CONTAINER_NAME_PREFIX}"